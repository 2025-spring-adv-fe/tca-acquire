...
// Hooks...
//
// Order pref is Ref hooks, state hooks, followed by effect hooks!
...
const addNewGameResult = async (
  ...
  const hotelWinTally = computeHotelWinTally(gameResults);
    ...
    >
        ...
        <div className="flex gap-1 ml-auto">
          {
            AppTitle === title && (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.1} stroke="currentColor" className="size-6">
      ...
      >
        <div className="modal-box">
          <h3 className="font-bold text-lg">Enter email to load & save games...</h3>
          <p className="py-4">
          <input 
                type="text" 
